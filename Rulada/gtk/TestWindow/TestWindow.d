...
version(cairo)private import gtkD.cairo.clock;
...
version(Tango)
{
	private import gtkD.tango.text.convert.Layout;
	private import gtkD.tango.io.Stdout;
	private import gtkD.tango.core.Thread;
	private import gtkD.tango.math.random.Kiss;
...
//private import gtkD.gtk.ComboBoxTextEntry;
...
//private import gtkD.gtk.ListItem;
private import gtkD.gtk.HBox;
private import gtkD.gtk.Arrow;
//private import gtkD.gtk.ListG;
//private import gtkD.gtk.OptionMenu;
...
//private import gtkD.gtk.SListG;
	...
	class T1 : Thread
	{
		...
		int runCommon()
		{
			while(1)
			{
				...
				else int buttonNum = std.random.rand()%threadTestButtons.length;
