...
protected:
	...
	bool exposeCallback(GdkEventExpose* event, Widget widget)
	{
		...
		cr.save();
			...
			cr.showText("Можно нарисовать картинку");
			cr.moveTo(30.0, 115.0);
			cr.showText("и написать простой текст");
...
void main(string[] args)
{
	...
	MainWindow win = new MainWindow("гткД Каиро: текст и картинка");
