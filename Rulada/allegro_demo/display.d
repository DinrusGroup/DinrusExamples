...
private BITMAP* page1, page2, page3;
private int current_page = 0;
private int num_pages;
private BITMAP* memory_buffer, back;
...
void init_display(int mode, int w, int h, ANIMATION_TYPE type)
{
   ...
   static if(ALLEGRO_VRAM_SINGLE_SURFACE)
      int r = set_gfx_mode(mode, w, h, w, h * num_pages);
   else
      int r = set_gfx_mode(mode, w, h, 0, 0);
   ...
   switch (animation_type) {
	 ...
	 break;
      ...
      case ANIMATION_TYPE.TRIPLE_BUFFER:
         ...
         if (!(gfx_capabilities & GFX_CAN_TRIPLE_BUFFER)) {
            strcpy(buf.ptr, gfx_driver.name);
            set_gfx_mode(GFX_TEXT, 0, 0, 0, 0);
