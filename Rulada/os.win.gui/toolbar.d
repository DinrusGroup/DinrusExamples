...
class ToolBarForm: os.win.gui.form.Form
{
	...
	private void initializeToolBarForm()
	{
		...
		//~DFL ToolBar:os.win.gui.label.Label=toolbar
		toolbar = new ToolBar();
		toolbar.name = "toolbar";
		toolbar.dock = os.win.gui.all.DockStyle.TOP;
		toolbar.bounds = os.win.gui.all.Rect(0, 0, 292, 26);
		toolbar.parent = this;
